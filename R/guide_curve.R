...
#' guide_curve(exfm14, "dh", "age", 72, 5, round_classes = T)
#' 
...
#' guide_curve(exfm14, "dh", "age", 72, 5, model = "Chapman-Richards", start_chap = c(b0=23, b1=0.03, b2 = 1.3))
#' 
#' guide_curve(exfm14, "dh", "age", 72, 5, model = "Bailey-Clutter", start_bailey = c( b0=3, b1=-130, b2 = 1.5))
#'  
#' @author Sollano Rabelo Braga \email{sollanorb@@gmail.com}
#'
guide_curve <- function(df, dh, age, age_index, n_class=4, model = "Schumacher", start_chap = c(b0=23, b1=0.03, b2 = 1.3), start_bailey = c( b0=3, b1=-130, b2 = 1.5), round_classes = F, font = "serif", grey_scale = T, output = "plot"){
