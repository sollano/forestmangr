...
BRAGA S. R.; OLIVEIRA, M. L. R.; GORGENS, E. B. forestmangr: Functions for Forest Mensuration and Management. R package version 0.9.2, 2020. Disponível em: <https://CRAN.R-project.org/package=forestmangr>

APA:

Sollano Rabelo Braga, Marcio Leles Romarco de Oliveira and Eric Bastos Gorgens (2020). forestmangr: Functions for Forest Mensuration and Management. R package version 0.9.2. https://CRAN.R-project.org/package=forestmangr
