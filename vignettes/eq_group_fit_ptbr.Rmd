...
Vamos ajustar alguns modelos para estimar a altura dominante, lineares e não-lineares, e comparálos em seguida. Vamos utilizar os primeiros 10 talhões do dado de exmplo exfm16.
```{r}
library(forestmangr)
library(dplyr)
library(tidyr)
...
e adicionar os valores estimados aos dados originais, utilizando o output `merge_est`, nomeando as variáveis estimadas utilizando `est.name`:
...
Podemos utlizar outros tipos de gráficos, como histogramas e gráficos de versus:
```{r, warning=FALSE, message=FALSE}
resid_plot(dados_est, "dh", "Schumacher","Chapman-Richards","Bailey-Clutter", "Curtis",
